 ...
 * @since 5.10.0
 */
public class WebEndpointAnnotationMapper extends AbstractSpringAnnotationMapper {
    @Override
    ...
    public String getName() {
        return "org.springframework.boot.actuate.endpoint.web.annotation.WebEndpoint";
    }
}
