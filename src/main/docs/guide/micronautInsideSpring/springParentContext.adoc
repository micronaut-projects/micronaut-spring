...
To use the Spring parent context feature (or other Spring integration features), add the following dependency to your build configuration:

dependency:micronaut-spring-context[scope="compile", groupId="io.micronaut.spring"]
