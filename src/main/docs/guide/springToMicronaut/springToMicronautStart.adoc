...
NOTE: If you are only going to references Spring annotations and not Spring classes or interfaces then `org.springframework.boot:spring-boot-starter` can be `compileOnly`